...
/**
 * CoinValueException.java - Calculator Exceptions 
 * 
...
public class UnknownOperatorException extends Exception
{
     ...
     * @return a new instance of UnknownOperatorException with the default message
     */
     ...
     * @return a new instance of UnknownOperatorException with set to string
